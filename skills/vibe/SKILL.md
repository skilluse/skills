---
name: vibe
description: Vibe Coding - Let AI handle the details while you focus on intent. Use when starting a coding session, continuing work, or running parallel agents.
---
...
Examples:
- `/vibe` - Continue vibing on current issue from Epic progress.md
- `/vibe issues/20251227-task05-config-store` - Vibe on specific issue

## When to Use

- Starting a new coding session
- User says "continue", "vibe", "next feature"
...
4. IMPLEMENT           →  One feature at a time: implement → test → commit
       ↓
5. END SESSION         →  Use /conventional-commit skill, update Epic progress.md
```
...
# 4. Use /conventional-commit skill to commit changes
```
...
- Use `/conventional-commit` skill for commits (not manual git commit)
